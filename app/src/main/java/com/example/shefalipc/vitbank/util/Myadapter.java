package com.example.shefalipc.vitbank.util;
...
import com.example.shefalipc.vitbank.R;
...
public class Myadapter extends RecyclerView.Adapter<Myadapter.ViewHolder> {
    ...
    public Myadapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if (viewType == TYPE_ITEM) {
            View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.activity_rowview,parent,false); //Inflating the layout
            ...
            View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.activity_headerview,parent,false); //Inflating the layout
